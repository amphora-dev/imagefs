#!/usr/bin/env python3
"""Generate simple dual-arch BuildStream elements from platform-agnostic recipes.
...
Scope: near-pure packages only (target triple, meson profile, depend rewrite).
Complex packages (Mesa, GLib, SDL2, ALSA, libpng, GStreamer, …) are
hand-maintained under elements/ and must not be listed in arch-recipes.txt.

Shared arch-independent packages (headers/proto) stay as plain elements and
are listed in wine-x86_64-shared.txt.
"""
